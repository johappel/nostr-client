...
**Purpose**: Describe what users can accomplish with **CalendarView** in the Nostr UI kit.
...
## API (Props)
```ts
// Replace with precise props for CalendarView
...
## MVP
- Example page: `/examples/app/calendarview/page.tsx`
...
## Code Snippet
```tsx
import { CalendarView } from "@/components/nostr-ui/CalendarView"
...
## Notes
NIP-52 kinds 31922–31925; month/list view; optional iCal export.
