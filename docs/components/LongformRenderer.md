...
**Purpose**: Describe what users can accomplish with **LongformRenderer** in the Nostr UI kit.
...
## API (Props)
```ts
// Replace with precise props for LongformRenderer
export interface LongformRendererProps {
  className?: string
  // ...
}
```
...
## MVP
- Example page: `/examples/longformrenderer/page.tsx`
...
## Code Snippet
```tsx
import { LongformRenderer } from "@/components/nostr-ui/LongformRenderer"
...
## Notes
Render kind:30023; MD/MDX with image resolver; safe HTML sanitation.
