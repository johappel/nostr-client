...
**Purpose**: Describe what users can accomplish with **Reactions** in the Nostr UI kit.
...
## API (Props)
```ts
// Replace with precise props for Reactions
...
## MVP
- Example page: `/examples/app/reactions/page.tsx`
...
## Code Snippet
```tsx
import { Reactions } from "@/components/nostr-ui/Reactions"
...
## Notes
Aggregate emojis; toggle my reaction; handle dedupe across relays.
