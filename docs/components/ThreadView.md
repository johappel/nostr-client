...
**Purpose**: Describe what users can accomplish with **ThreadView** in the Nostr UI kit.
...
## API (Props)
```ts
// Replace with precise props for ThreadView
...
## Code Snippet
```tsx
import { ThreadView } from "@/components/nostr-ui/ThreadView"
...
## Notes
Parse NIP-10 tags (root/reply/mentions) and render hierarchical replies.
